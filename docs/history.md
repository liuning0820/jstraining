...
- 端工程师
   “端工程师”通常指的是软件开发领域的工程师，可以细分为前端工程师、后端工程师和全端工程师。前端工程师主要负责用户界面和用户体验的设计和开发，而后端工程师则专注于服务器、数据库和应用程序逻辑的开发。全端工程师则需要同时具备前后端开发能力。 
  - 手机端
  - PC 端
  - TV 端
  - VR 端
  - ……
- 云工程师
   "云工程师"，也称为云计算工程师，是指负责云计算相关的技术工作，包括设计、实施、维护和优化云端基础设施与服务的专业人员. 他们的工作涵盖了广泛的领域，从设计云架构到管理云端资源，再到保障云端系统的安全性和稳定性   
